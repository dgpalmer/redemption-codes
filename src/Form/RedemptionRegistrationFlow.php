...
use Drupal\redemption_codes\Form\RedemptionRegistrationFlowFormInterface;
...
/**
 * Class RedemptionRegistrationFlow.
 *
 * @package Drupal\redemption_codes\Form
 */
class RedemptionRegistrationFlow extends AEUserRegisterForm {
  ...
  public function getFormId() {
    return 'redemption_registration_flow';
  }
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    // On the AE form we always have a password.
